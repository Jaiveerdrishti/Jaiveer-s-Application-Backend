...
async function seedUser () {
  try {
    ...
    userToBeInserted = await userDbService.findOne({ 'username':'Adaline_Gottlieb' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'AlEX9DiZ3OoAdpz',
        'isDeleted':false,
        'username':'Adaline_Gottlieb',
        'email':'Kale.Toy@gmail.com',
        'isActive':true,
      ...
      await userDbService.update({ 'username':'Adaline_Gottlieb' }, userToBeInserted);
    }
    userToBeInserted = await userDbService.findOne({ 'username':'Estella64' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'3_XsgqfJ2rtJOe0',
        'isDeleted':false,
        'username':'Estella64',
        'email':'Juston.Gerlach@hotmail.com',
        'isActive':true,
      ...
      userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
      await userDbService.update({ 'username':'Estella64' }, userToBeInserted);
    }
